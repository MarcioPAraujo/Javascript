...
export class prisionEntities1695414764377 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "criminalRecord" ("id" character varying NOT NULL, "prisoner" character varying NOT NULL, "sentence" character varying NOT NULL, "section" character varying NOT NULL, "reabiitation_program" character varying NOT NULL, "prision" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_fcc4d089d6aed169e15c1f04acb" PRIMARY KEY ("id"))`);
