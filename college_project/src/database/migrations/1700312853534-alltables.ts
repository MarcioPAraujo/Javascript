...
export class alltables1700312853534 implements MigrationInterface {
    name = 'alltables1700312853534'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "reabilitationprogram" ADD CONSTRAINT "FK_b7018c6557b09f275dcb5a0de82" FOREIGN KEY ("responsableId") REFERENCES "employees"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "prisoner" ADD CONSTRAINT "FK_9069846a476bac44c2352c59f37" FOREIGN KEY ("reabilitationProgramId") REFERENCES "reabilitationprogram"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "prisoner" ADD CONSTRAINT "FK_0cf936dde4e609bb02ea2cee68b" FOREIGN KEY ("criminalRecordId") REFERENCES "criminalrecord"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "criminalrecord" ADD CONSTRAINT "FK_bbb12a979e840df80cca4e6592d" FOREIGN KEY ("reabiliatationProgramId") REFERENCES "reabilitationprogram"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "criminalrecord" ADD CONSTRAINT "FK_449904f161966876796b2d45bb0" FOREIGN KEY ("prisionId") REFERENCES "prision"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "criminalrecord" DROP CONSTRAINT "FK_449904f161966876796b2d45bb0"`);
        await queryRunner.query(`ALTER TABLE "criminalrecord" DROP CONSTRAINT "FK_bbb12a979e840df80cca4e6592d"`);
        await queryRunner.query(`ALTER TABLE "criminalrecord" DROP CONSTRAINT "FK_f1fc108eb8486fadba9c98a9225"`);
        await queryRunner.query(`ALTER TABLE "prisoner" DROP CONSTRAINT "FK_0cf936dde4e609bb02ea2cee68b"`);
        await queryRunner.query(`ALTER TABLE "prisoner" DROP CONSTRAINT "FK_9069846a476bac44c2352c59f37"`);
        await queryRunner.query(`ALTER TABLE "prisoner" DROP CONSTRAINT "FK_aa1a63dfa0a7ef64f0a4a325dea"`);
        await queryRunner.query(`ALTER TABLE "reabilitationprogram" DROP CONSTRAINT "FK_b7018c6557b09f275dcb5a0de82"`);
